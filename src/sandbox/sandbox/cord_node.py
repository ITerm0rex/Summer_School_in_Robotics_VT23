...
from geometry_msgs.msg import Twist, Quaternion, Point, Pose2D, Vector3
...
class DifferentialDrive(Node):
    ...
    def odom_callback(self, msg: Odometry):
        current = Odometry_to_Pose2D(msg)
        target: Pose2D = self.target_list[self.target_index]
